...
version = "v1.0.0"
date = "Nov 22 2020, 1:00 PM EDT"

import ctypes
ctypes.windll.kernel32.SetConsoleTitleW(f'LiteScript ' + version + ' Shell')
...
global_symbol_table.set("input_init", BuiltInFunction.input_int)
...
global_symbol_table.set("lite", BuiltInFunction.run)
